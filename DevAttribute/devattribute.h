...
void cleaning(int x, int y, int width, int height, consoleColor foreground=BLACK, consoleColor background=BLACK);
void pause();
...
HWND getConsoleHwnd();
void mButtonChecker(int rangeXmin, int rangeXmax, int rangeYmin, int rangeYmax, int button = VK_LBUTTON);
class strtools
{
public:
